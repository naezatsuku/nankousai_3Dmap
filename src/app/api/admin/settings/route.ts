...
export async function GET() {
  const { data } = await serviceDb()
    .from('site_settings')
    .select('is_public, map_enabled, like_count_visible, festival_sat, festival_sun, announcement_trigger_minutes, wait_stage_count, wait_threshold_low, wait_threshold_high, wait_threshold_3')
    .single()
